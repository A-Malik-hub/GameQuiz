...
class QuizHardForm(Toplevel):
    ...
    def __init__(self, master = None):
        ...
        self.title('Quizzaz - Kelola Quiz - Susah')
        ...
        self.tree.column("#0", width=800 ,stretch=NO)
    ...
    def get_products(self):
        ...
        # getting data
        query = 'SELECT * FROM quiz_hard ORDER BY id DESC'
    ...
    def edit_records(self, new_quiz, quiz, answer):
        query = "UPDATE quiz_hard SET quiz = ? WHERE quiz = ? AND answer_tohelp = ?"
