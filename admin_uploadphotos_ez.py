...
def qz_020_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_020'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def qz_021_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_021'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def qz_022_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_022'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def qz_030_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_030'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def qz_031_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_031'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def qz_032_edit():
    ...
    c = conn.cursor()
    #Query
    c.execute("UPDATE quiz_easy SET qz_photo = (?) WHERE id='qz_ez_032'", (photo_data,))
    #Convert Image data to binary data
    #Cursor execute
    #Connection commit
    conn.commit()
...
def ez_photoedit():
    ...
    show_photo_ez_010= ImageTk.PhotoImage(resized)
    global show_blank_010
    show_blank_010 = Label(qz_010_frame, image=show_photo_ez_010)
    show_blank_010.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_010 = Label(qz_010_frame, image=get_data_010('qz_ez_010')).pack
    #Edit Button
    ...
    show_blank_011 = Label(qz_011_frame, image=show_photo_ez_011)
    show_blank_011.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_011 = Label(qz_011_frame, image=get_data_011('qz_ez_011')).pack
    #Edit Button
    ...
    show_blank_012 = Label(qz_012_frame, image=show_photo_ez_012)
    show_blank_012.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_012 = Label(qz_012_frame, image=get_data_012('qz_ez_012')).pack
    #Edit Button
    ...
    show_blank_020 = Label(qz_020_frame, image=show_photo_ez_020)
    show_blank_020.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_020 = Label(qz_020_frame, image=get_data_020('qz_ez_020')).pack
    #Edit Button
    ez_010_edit = Button(qz_020_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_020_edit)
    ez_010_edit.pack(anchor=S, padx=15)
    ...
    show_blank_021 = Label(qz_021_frame, image=show_photo_ez_021)
    show_blank_021.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_021 = Label(qz_021_frame, image=get_data_021('qz_ez_021')).pack
    #Edit Button
    ez_021_edit = Button(qz_021_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_021_edit)
    ...
    show_blank_022 = Label(qz_022_frame, image=show_photo_ez_022)
    show_blank_022.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_022 = Label(qz_022_frame, image=get_data_022('qz_ez_022')).pack
    #Edit Button
    ez_022_edit = Button(qz_022_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_022_edit)
    ...
    show_blank_030 = Label(qz_030_frame, image=show_photo_ez_030)
    show_blank_030.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_030 = Label(qz_030_frame, image=get_data_030('qz_ez_030')).pack
    #Edit Button
    ez_030_edit = Button(qz_030_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_030_edit)
    ...
    show_blank_031 = Label(qz_031_frame, image=show_photo_ez_031)
    show_blank_031.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_031 = Label(qz_031_frame, image=get_data_031('qz_ez_031')).pack
    #Edit Button
    ez_031_edit = Button(qz_031_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_031_edit)
    ...
    show_blank_032 = Label(qz_032_frame, image=show_photo_ez_032)
    show_blank_032.pack(anchor=CENTER, padx=5, pady=10)
    show_photo_032 = Label(qz_032_frame, image=get_data_032('qz_ez_032')).pack
    #Edit Button
    ez_032_edit = Button(qz_032_frame, text="Edit Foto", bg="#ffeb3b", padx=5, font=('roboto', '10', 'bold'), command=qz_032_edit)
